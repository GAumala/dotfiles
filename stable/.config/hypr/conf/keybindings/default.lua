...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + Z", hl.dsp.focus({ workspace = 1}), { description = "Focus workspace 1" })
    hl.bind(mainMod .. " + X", hl.dsp.focus({ workspace = 2}), { description = "Focus workspace 2" })
    hl.bind(mainMod .. " + C", hl.dsp.focus({ workspace = 3}), { description = "Focus workspace 3" })
    hl.bind(mainMod .. " + V", hl.dsp.focus({ workspace = 4}), { description = "Focus workspace 4" })
    hl.bind(mainMod .. " + D", hl.dsp.focus({ workspace = 5}), { description = "Focus workspace 5" })
...
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-cliphist"), { description = "Open clipboard manager" })
